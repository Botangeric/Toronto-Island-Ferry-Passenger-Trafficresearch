...
write_csv(monthly_summary, "starter_folder-main/data/analysis_data/analysis_data_month.csv")
write_csv(basic_stats, "starter_folder-main/data/analysis_data/basic_stats.csv")
write_csv(sales_by_day, "starter_folder-main/data/analysis_data/sales_by_day.csv")
write_csv(hour_data, "starter_folder-main/data/analysis_data/hour_data.csv")